...
package com.example.alertbox.databinding;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btn1,
      @NonNull Button btn2, @NonNull Button btn3, @NonNull ConstraintLayout main,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, btn1, btn2, btn3, main, textView);
    }
